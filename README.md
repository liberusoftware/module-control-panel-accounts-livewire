...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-control-panel-accounts-livewire?sort=semver)](https://github.com/liberusoftware/module-control-panel-accounts-livewire/releases/latest) [![Tests](https://github.com/liberusoftware/module-control-panel-accounts-livewire/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-control-panel-accounts-livewire/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-control-panel-accounts-livewire
```
...
<a href="https://github.com/liberusoftware/module-control-panel-accounts-livewire/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-control-panel-accounts-livewire" alt="Contributors to liberusoftware/module-control-panel-accounts-livewire">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-control-panel-accounts-livewire/graphs/contributors).
